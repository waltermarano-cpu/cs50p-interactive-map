...
import {
  aula1QuizModule, // Importa o módulo específico da Aula 1
...
const Aula1QuizContainer: React.FC = () => {
  const moduleId = aula1QuizModule.moduleId;
  ...
  const startNewQuizAttempt = useCallback(() => {
    const selectedQuestions = selectUniqueQuizQuestions(aula1QuizModule, userProgress, 5);
    ...
    <div className="min-h-screen bg-gray-900 flex items-center justify-center p-4">
      {!showQuiz ? (
        <div className="space-y-6 w-full max-w-md">
          <QuizModuleProgress quizModule={aula1QuizModule} userProgress={userProgress} />
...
export default Aula1QuizContainer;
