...
const Aula5QuizContainer: React.FC = () => {
  const moduleId = aula5QuizModule.moduleId;
  ...
  const startNewQuizAttempt = useCallback(() => {
    const selectedQuestions = selectUniqueQuizQuestions(aula5QuizModule, userProgress, 5);
    ...
    <div className="min-h-screen bg-gray-900 flex items-center justify-center p-4">
      {!showQuiz ? (
        <div className="space-y-6 w-full max-w-md">
          <QuizModuleProgress quizModule={aula5QuizModule} userProgress={userProgress} />
...
export default Aula5QuizContainer;
