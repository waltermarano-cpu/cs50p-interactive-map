...
const Aula2QuizContainer: React.FC = () => {
  const moduleId = aula2QuizModule.moduleId;
  ...
  const startNewQuizAttempt = useCallback(() => {
    const selectedQuestions = selectUniqueQuizQuestions(aula2QuizModule, userProgress, 5);
...
export default Aula2QuizContainer;
